...
def fun_cond_pos(func):
    if func == ZER or func == AFF or func == DEL:
        return 1
        ...
        while curnode is not None:
            ...
            if curnode.curpos < curnode.stoppos:
                if curnode.curpos == curnode.condpos:
                    ...
                    elif curnode.fun == DEL:
                        e_ratio = curnode.params[0].curval
                        if self.vars[-1] > e_ratio:
                            curnode.stoppos = 2
                ...
                if curnode.type == NodeType.FUN:
                    if curnode.fun == SUM:
                        ...
                        try:
                            ...
                            val = 0
                    elif curnode.fun in {EQ, GRT, LRT, ZER, AFF, DEL}:
